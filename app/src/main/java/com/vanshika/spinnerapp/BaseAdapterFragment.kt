...
import com.vanshika.spinnerapp.databinding.FragmentBaseAdapterBinding
...
class BaseAdapterFragment : Fragment() {
    ...
    var array = arrayListOf("red","green","blue","black","orange")
    private var baseAdapterClass = BaseAdapterClass(array)
